    ...
    func updateData(data: BookingModel,status: String) {
        ...
        ref.updateData([
            ...
            if let err = err {
                ...
                status == bConfirm ? self.addNotification(message: "Your request has been confirmed by \(GFunction.user.name)", email: data.email, name: data.name) : self.addNotification(message: "Your request has been rejected by \(GFunction.user.name)", email: data.email, name: data.name)
...
//extension YourBookingTVC: UICollectionViewDelegate,UICollectionViewDataSource {
//    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
//        return 3
//    }
//
//    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
//        let colCell = collectionView.dequeueReusableCell(withReuseIdentifier: "AddDiseasesCell", for: indexPath) as! AddDiseasesCell
//        return colCell
//    }
//
//
